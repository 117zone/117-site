/*
    ...
    (But change the script src URL to wherever you have this widget stored on your site!)
        ...
        <div id="c_widget"></div>
        <script src="https://117.zone/guestbook%2Fcomment-widget.js"></script>
...
const s_stylePath = 'https://117.zone/guestbook%2Fcomment-widget-dark.css';
const s_formId = '1FAIpQLSeTGt0AF_aOctXgRJ1OnHZ0k6rT2qnzzGMPedSPr6bGHNq-OA';
const s_nameId = '2007267406';
const s_websiteId = '1117407370';
const s_textId = '1568359823';
const s_pageId = '1875136128';
const s_replyId = '1373054589';
const s_sheetId = '1HZi2rLUhZmU3UrmO-GTkY-JKDlUyZQgh7KfuiIiFPH8';
